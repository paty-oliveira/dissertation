...
class PIPITSitsExtraction(IIdentificationProcess):
    ...
    cmd_args_its_extraction = ["pipits_funits", "-i", "out_seqprep/prepped.fasta", "-o", "out_funits", "-x", "ITS2", "-v", "-r"]
    ...
    def __extract_its(self):
        ...
        process_to_execute = subprocess.call(PIPITSitsExtraction.cmd_args_its_extraction, 
