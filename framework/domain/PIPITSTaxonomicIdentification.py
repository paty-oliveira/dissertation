...
class PIPITSTaxonomicIdentification(IIdentificationProcess):
    ...
    cmd_args_taxonomic_id = ["pipits_process", "-i", "out_funits/ITS.fasta", "-o", "out_process", "-v", "-r"]
    ...
    def __get_taxonomic_id(self):
        ...
        process_to_execute = subprocess.call(PIPITSTaxonomicIdentification.cmd_args_taxonomic_id, 
