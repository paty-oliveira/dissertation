...
class IdentificationStep(IStep):
        ...
        if self.__execution:
            ...
            for step in self.__pipits_steps:
                ...
                if result:
                    ...
                    specie_identification_results = ReportWriter(filepath).write_identification(specie)
    ...
    def __get_specie_identification(self):
        ...
        phylotype_file = pd.read_csv(self.__phylotype_file, sep='\t', engine='python', encoding='utf-8')
