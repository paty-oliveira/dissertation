...
class Application:
    ...
    def start(self):
        ...
        if self.__is_mode(params['mode'], 'console'): self.run_console()
        
        elif self.__is_mode(params['mode'], 'gui'): self.run_gui()
        
        else: self.run_batch_mode(params)
    ...
    def __prepare_environment(self):
        'Prepare environment of execution before the start of the application'
    ...
    def __configure_arguments(self):
        ...
        "Pipeline for identification of Candida species and detection of antifungal resistance")
        ...
        parser.add_argument('-file_ident',
            nargs='?', 
        ...
        parser.add_argument('-file_detect', 
            nargs='?',
    ...
    def __is_mode(self, base_mode, mode):
        ...
        return base_mode == mode.lower()   \
            or base_mode == mode.upper()


    def __removal_folder_content(self, path_folder):
        'Remove all files and directories in a specific folder.'
